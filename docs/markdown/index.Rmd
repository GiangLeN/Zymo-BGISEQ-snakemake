...
The zymoBIOMICS Mock community contains 8 bacteria and 2 fungi at specific concentration.
In many projects, this mock has been sequenced and used as the positive control.
Using publicly available data from [Sequence Read Archive](https://www.ncbi.nlm.nih.gov/sra) (SRA), we will download and build a metagenomic pipeline for re-analysis.
The tutorial also looks at different tools and approaches and compared them for benchmark purposes.
